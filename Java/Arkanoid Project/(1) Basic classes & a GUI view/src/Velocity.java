...
public class Velocity {
    ...
    /**
     * This is constructor function of Velocity object.
     * The Input:
     *
     * @param newDx - the change of x.
     * @param newDy - the change of y.
     *              The Function Operation: The function initializes
     *              two input values in the new Velocity object.
     */
    ...
    /**
     * This is more constructor function of Velocity object.
     * The Input:
     *
     * @param angle - the angle of the speed vector - double number.
     * @param speed - the speed of the ball - double number.
     *              The Function Operation: The function initializes
     *              two input values in the new Velocity object
     *              after calculating dx and dy using Math package.
     * @return new Velocity object according the inputs values.
     */
    public static Velocity fromAngleAndSpeed(final double angle,
                                             final double speed) {
        double dx = speed * Math.sin(Math.toRadians(angle));
        double dy = speed * Math.cos(Math.toRadians(angle)); // check if -speed
     ...
     *
     * @param p - input point.
     * @return the new point after adding to the input point:
    ...
    /**
     * return dx change of the Velocity.
     * The Input: no input
     *
    ...
    /**
     * return dy change of the Velocity.
     * The Input: no input
     *
    ...
    public double getSpeed() {
        double speedResult = Math.sqrt(Math.pow(this.dx, 2)
                + Math.pow(this.dy, 2));
        return speedResult;
    }
     ...
     * @return 1 if the first Velocity bigger than the other.
     * return 2 if the second Velocity bigger than the other.
