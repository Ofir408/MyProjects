...
public class Line {
    ...
    public boolean isIntersecting(final Line other) {
    	...
    	/*if (this.end.getX() - this.start.getX() == 0) {
    		 Point result = findIntersectionForEqualsX(this, other);
    		 if (result.getY() > this.minAndMaxPoints()[0].getY()
    	                && result.getY() < this.minAndMaxPoints()[1].getY()) {
    	            if (result.getY() > other.minAndMaxPoints()[0].getY()
    	                    && result.getY() < other.minAndMaxPoints()[1].getY()) {
    	            	return true;
    	            }
         }
    	 } */
    	/*
    		if (other.end.getX() - other.start.getX() == 0) {
        		 Point resultt = findIntersectionForEqualsX(other, this);
        		 if (resultt.getY() >= other.minAndMaxPoints()[0].getY()
        	                && resultt.getY() <= other.minAndMaxPoints()[1].getY()) {
        	            if (resultt.getY() >= this.minAndMaxPoints()[0].getY()
        	                    && resultt.getY() <= this.minAndMaxPoints()[1].getY()) {
        	            	return true;
        	            }
             }
    		} */
     ...
     */
    public boolean isInputPointOnOneLine(Point inputP) {
