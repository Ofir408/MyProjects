...
public class GameLevel implements Animation {
    ...
    public void initialize() {
        ...
        Block deathBlock = new Block(new Rectangle(new Point(0, 600), 800, 0.01), 1, Color.YELLOW, Color.BLACK);
    ...
    public void playOneTurn() {
        ...
        this.runner.run(new CountdownAnimation(2, 3, this.sprites)); // countdown
        // before
        // turn
        // starts.
        this.running = true;
    ...
    private void enterBallToGame(List<Ball> ballsList) {
        ...
        for (int i = 0; i < ballsList.size(); i += 1) {
            ...
            // temp.setOriginalVel(temp.getVelocity());
