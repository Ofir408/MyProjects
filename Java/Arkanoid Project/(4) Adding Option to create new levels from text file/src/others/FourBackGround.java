...
/**
 * FourBackGround Class - implements Sprite. The second background in our game -
 * "Final Four"
 *
...
public class FourBackGround implements Sprite {
    ...
    public List<Block> getBlocks() {
        ...
        Block[] slides = {new Block(new Rectangle(new Point(0, 40), 800, 20), 1, c, stroke),
                ...
                new Block(new Rectangle(new Point(0, 620), 600, 20), 1, c, stroke)}; // the
        // lowest
        // block.
        ...
        for (int t = 1; t < 8; t += 1) {
            ...
            for (int i = 0; i < 725; i += 40) {
                ...
                Block b1 = new Block(new Rectangle(new Point(740 - i, 140 + t * 20), 40, 20), hits, c, stroke);
                blocksList.add(b1);
            }
            hits = 1;
        }
