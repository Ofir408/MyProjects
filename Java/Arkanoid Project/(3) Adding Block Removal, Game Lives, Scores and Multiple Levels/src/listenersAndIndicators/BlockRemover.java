...
public class BlockRemover implements HitListener {
     ...
     * from the game. Remember to remove this listener from
     * the block that is being removed from the game.
     *
     * @param beingHit - the block that hit and maybe we will remove him
     *                 from the current game (if it reach 0 hit-points).
    ...
    public void hitEvent(Block beingHit, Ball hitter) {
        ...
        if (beingHit.getHitPointsNumber() == 0) {
            // reached 0 hit-points so we should remove the listener from the game.
