...
@Override
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		this.firstPlayerColor.setText(String.valueOf(GameData.firstPlayer));
		this.secondPlayerColor.setText(String.valueOf(GameData.secondPlayer));
		this.boardSize.setText(String.valueOf(GameData.ColNumber));
	}
