...
private char[][] boardArray;
	...
	/**
	 * insert a sign to the board in the a specified location.
	 * @param signToAdd is the sign to insert
	 * @param row is the row of the board to insert the sign
	 * @param col is the column of the board to insert the sign
	 */
