...
class StateAsOdomPublisher(object):
    ...
    def __init__(self, state_name, publish_topic_name):
        ...
        self.publisher = rospy.Publisher(publish_topic_name, Odometry, queue_size=1)
	...
	#print "published to: " + self.publish_topic_name


if __name__=="__main__":
    print "true_pose_from_gazebo initialzed!" 
